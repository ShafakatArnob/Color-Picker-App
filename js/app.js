...
closeAdjusts.forEach((button, index) =>{
    button.addEventListener('click', () =>{
...
function checkTextContrast(randomColor, hexText){
...
function hslControls(e){
    ...
    // Colorizing other inputs/sliders based on the change of one input/slider
    colorizeSliders(color, hue, brightness, saturation);
}
...
function copyToClipboard(hex){
    // How to copy something to clipboard
